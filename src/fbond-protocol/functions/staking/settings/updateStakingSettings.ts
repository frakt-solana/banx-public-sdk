...
import { ENCODER, STAKING_SETTINGS_PREFIX } from '../../../constants';
import { returnAnchorProgram } from '../../../helpers';

type UpdateStakingSettings = (params: {
...
export const updateStakingSettings: UpdateStakingSettings = async ({
  programId,
  connection,
  addComputeUnits,
  accounts,
  ...
  instructions.push(
    await program.methods
      .updateStakingSettings(new BN(args.lowerRewardsLimit), new BN(args.upperRewardsLimit))
