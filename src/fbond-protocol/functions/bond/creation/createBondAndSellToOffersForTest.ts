...
type CreateBondAndSellToOffersForTest = (params: {
...
export const createBondAndSellToOffersForTest: CreateBondAndSellToOffersForTest = async ({
  programId,
  connection,
  args,
  addComputeUnits,
  ...
  instructions.push(
    await program.methods
      .createBondAndSellToOffersForTest(sellBondParams)
