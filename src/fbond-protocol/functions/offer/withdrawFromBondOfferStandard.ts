...
type WithdrawFromBondOfferStandard = (params: {
...
export const withdrawFromBondOfferStandard: WithdrawFromBondOfferStandard = async ({
  programId,
  connection,
  accounts,
  args,
  ...
  instructions.push(
    await program.methods
      .withdrawFromBondOfferStandard(new BN(args.amountOfTokensToWithdraw))
      .accounts({
