...
type DepositToBondOfferStandard = (params: {
...
export const depositToBondOfferStandard: DepositToBondOfferStandard = async ({
  programId,
  connection,
  accounts,
  args,
  ...
  instructions.push(
    await program.methods
      .depositToBondOfferStandard(new BN(args.amountOfSolToDeposit))
      .accounts({
