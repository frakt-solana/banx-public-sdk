...
import { AUTHORIZATION_RULES_PROGRAM, EMPTY_PUBKEY, ENCODER, HADESPIN_LEADERBOARD_ENTRY_PREFIX, METADATA_PROGRAM_PUBKEY, ROUND_PREFIX, ROUND_SETTING_PREFIX, ROUND_TXN_VAULT_PREFIX, USER_ROUND_PREFIX } from '../../../constants';
...
export const claimWinnerNft: ClaimWinnerNft = async ({
  programId,
  connection,
  addComputeUnits,
  accounts,
  ...
  const ownerTokenRecord = findTokenRecordPda(accounts.collateralTokenMint, roundTxnTokenAccount);
