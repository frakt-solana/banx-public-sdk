...
type JoinRoundWithNftTest = (params: {
...
export const joinRoundWithNftTest: JoinRoundWithNftTest = async ({
  programId,
  connection,
  addComputeUnits,
  args,
  ...
  instructions.push(
    await program.methods
      .joinRoundWithNftTest(roundNumber, new BN(userRoundSeed))
      .accountsStrict({
        round: round,
        userRound: userRound,
