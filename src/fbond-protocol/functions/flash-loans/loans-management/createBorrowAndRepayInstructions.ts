...
type CreateBorrowAndRepayInstructions = (params: {
    ...
    pubkeysForLookupTable: web3.PublicKey[];
}>;
...
export const createBorrowAndRepayInstructions: CreateBorrowAndRepayInstructions = async ({ programId, connection, args, accounts }) => {
    ...
    return { borrowInstruction: instructions[0], repayInstruction: instructions[1], pubkeysForLookupTable: [accounts.pool, accounts.userPubkey,solFundsVault, SYSVAR_INSTRUCTIONS_PUBKEY] };
};