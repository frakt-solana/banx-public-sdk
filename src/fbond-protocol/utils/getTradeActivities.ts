...
export const getTransferAmountFromInnerInstructions = (innerInstruction: web3.ParsedInnerInstruction) => {
...
export enum InnerProgramTypes {
  System = 'system',
  SplToken = 'spl-token',
}

export enum InnerInstructionTypes {
  Transfer = 'transfer',
}
